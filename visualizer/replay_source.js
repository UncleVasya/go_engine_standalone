...
//		console.log(planet);
//		console.log(planetStats[z]);
//		console.log(z);
            planet.owner = planetStats[z].owner;
            planet.numShips = planetStats[z].numShips;
		if (planetStats[z].owner == 1 || planetStats[z].owner == 2) {
			console.log(planetStats[z].numShips);
		}
...
//            ctx.beginPath();
//            ctx.arc(300, this.canvas.height - 300, 50, 0, Math.PI*2, true);
//            ctx.closePath();
//            ctx.fillStyle = color;
...
//            ctx.fill();
    ...
    drawChart: function(frame){
        var canvas = this.chart; //document.getElementById('chart');
	...
	console.log(input);
        this.players[0] = input["player_one"];
        this.players[1] = input["player_two"];
        this.playerIds[0] = input["user_one_id"];
        this.playerIds[1] = input["user_two_id"];
	console.log(this.players[0]);
	console.log(this.players[1]);
	console.log(this.playerIds[0]);
	console.log(this.playerIds[1]);
	...
	this.map_id = input["map_id"];
	var data = input["data"];


        this.planets = data[0].map(ParserUtils.parsePlanet);
